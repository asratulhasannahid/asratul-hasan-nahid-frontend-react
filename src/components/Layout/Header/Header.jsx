  ...
  return (
    <header>
      ...
      >
        ...
        {/* Mobile Dropdown */}
        <div
          className={`md:hidden rounded-t-4xl absolute top-[61px] left-0 w-full bg-white/98 border-b border-[#5DBF8A]/20 transition-all duration-300 ease-in-out origin-top overflow-hidden rounded-b-2xl shadow-xl ${
            isMobileMenuOpen
